...
public class SiraliYokEdici : MonoBehaviour
{
    ...
    void Start()
    {
        uzayGemisi = GameObject.FindGameObjectWithTag("Player");// uzay gemisine eklediğimiz tag ile ulaşıyoruz -FindGameObjectWithTag("Player")
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            asteroidList.Add(asteroid); //astroidi list in içine kaydediyoruz
        }
    ...
    public void HedefiYokEt()//ilk astroid tok edildikten sınra sıralı yok edilmenin devam etmesi için bu method dışarıdan çağırılacak o yuzden -public yaptık
    {
